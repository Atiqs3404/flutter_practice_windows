      ...
      body: Column(
        children: [
          Row(
            children: [
              _buildSummaryCard(
                  title: 'Earning', value: totalEarning, color: Colors.green),
              _buildSummaryCard(
                  title: 'Expense', value: totalExpense, color: Colors.red),
              _buildSummaryCard(
                  title: 'Balance', value: balance, color: Colors.blue),
            ],
          ),
          SizedBox(
            height: 10,
...
Widget _buildList(
    List<Map<String, dynamic>> items, Color color, bool isEarning) {
